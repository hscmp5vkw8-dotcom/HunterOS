...
export function ProductSocial({productId}:{productId:string}) {
  ...
  async function share() {
    ...
    if(!await confirmAction('Share this gear pick?',`Share this product and your note with ${group?group.name:'your accepted friends'}? Your locker, trip details and locations are not included.`))return;
