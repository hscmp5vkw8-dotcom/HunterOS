...
Status verified September 26, 2026 UTC. This release adds the expanded catalog and photos, combined filters, reusable loadouts and Off-road planning for ATVs, UTVs and 4x4 trucks/Jeeps. Feature details and compatibility notes are in [OUTDOOR-EXPANSION.md](OUTDOOR-EXPANSION.md).
...
- Apple build `4c600966-2dab-4e0a-9931-15bde5e019be` is VALID. Team (Expo) is assigned and testing internally. Private Family Beta is assigned and **Waiting for Review** as of 02:38:34 UTC.
...
- Google Play internal release 3 is prepared as `0.5.0 (9) - Loadouts and off-road`, with release notes. Chrome's connected extension still rejects file attachment for local-file access, including after the owner reported enabling the switch. No version 9 bundle was attached or published.
- The active internal release remains **0.4.2 (8)**. Keep the existing tester list and [opt-in link](https://play.google.com/apps/internaltest/4701644933804462998).
- Resume by uploading the existing `HunterOS-0.5.0-build9-android.aab` to release 3, previewing validation and publishing to the internal track. Verify Active / Available to internal testers before claiming 0.5.0 is downloadable. Do not rebuild or repeat signing setup.
